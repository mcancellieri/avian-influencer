document.addEventListener('DOMContentLoaded', () => {
    ...
    const stories = {
        ...
        '0': { name: 'Avian Influencer', text: 'This show was brought to you by Matteo Cancellieri you can find his work at matteocancellieri.com (good luck spelling that), Tony Gee find his otherworldly sounds and creations @RedFishSounds on Instagram and David Pride you can find his magic at @davidpride3160 on Youtube. Credits for voice actors: Sus Booth and Rapha Weedon. ', img: "a", audio: new URL('./assets/RayMcRavenface.mp3', import.meta.url).toString()},
        '*': { name: 'ArtBox', text: 'ARTBOX LB is a unique community art project transforming a traditional red telephone box into a vibrant, ever-changing space for creativity on Leighton Buzzard High Street. Showcasing local artists, ideas, and inspiration, it’s both an artwork in itself and a platform for others to share their talent. Created by three passionate locals — Lobke (film production & photography), Sally (fine artist and former Chair of Leighton Buzzard Art Society), and Tony (musician and sound artist). ARTBOX LB brings art directly into the community in a simple, accessible, and joyful way. Search Artbox LB on Facebook', img: "a", audio: new URL('./assets/dodo.mp3', import.meta.url).toString()},
